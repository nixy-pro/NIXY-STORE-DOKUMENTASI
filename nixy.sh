...
echo -e " ${NC} - $BRED » ${bblue}SHADOW/WS/GRPC ${YELL}     : ${BRED}$ssa${NC}"
echo -e " ${NC} - $BRED » ${bblue}SSH/OPENVPN/UDP ${YELL}    : ${green}$ssh1${NC}"
echo -e " ${NC} ~ ====================================================~$NC"
echo -e " ${NC} ~ ====================================================~${NC}"
echo -e " ${NC} - $BRED » ${bblue}SSH ${YELL}                : ${NC}$status_ssh${NC}"
echo -e " ${NC} - $BRED » ${bblue}XRAY ${YELL}               : ${BRED}$status_xray${NC}"
echo -e " ${NC} - $BRED » ${bblue}NGINX ${YELL}              : ${NC}$status_nginx${NC}"
echo -e " ${NC} - $BRED » ${bblue}HAPROXY ${YELL}            : ${green}$status_haproxy${NC}"
echo -e " ${NC} - $BRED » ${bblue}WS-EPRO ${YELL}            : ${NC}$status_ws_epro${NC}"
echo -e " ${NC} - $BRED » ${bblue}DROPBEAR ${YELL}           : ${NC}$status_dropbear${NC}"
echo -e " ${NC} ~ ====================================================~$NC"
echo -e " ${NC} ~ ====================================================~${NC}"
