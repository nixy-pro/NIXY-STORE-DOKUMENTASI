...
echo -e " ${NC} ~ ====================================================~$NC"
echo -e " ${NC} ~ ====================================================~${NC}"
echo -e " ${NC} - $BRED » ${bblue}VLESS/WS/GRPC ${YELL}      : ${NC}$ssh1${NC}"
echo -e " ${NC} - $BRED » ${bblue}VMESS/WS/GRPC ${YELL}      : ${NC}$vma${NC}"
echo -e " ${NC} - $BRED » ${bblue}TROJAN/WS/GRPC ${YELL}     : ${NC}$trb${NC}"
echo -e " ${NC} - $BRED » ${bblue}SHADOW/WS/GRPC ${YELL}     : ${NC}$ssa${NC}"
echo -e " ${NC} - $BRED » ${bblue}SSH/OPENVPN/UDP ${YELL}    : ${NC}$ssh1${NC}"
echo -e " ${NC} ~ ====================================================~$NC"
echo -e " ${NC} ~ ====================================================~${NC}"
...
echo -e " ${NC} ~ ====================================================~$NC"
echo -e " ${NC} ~ ====================================================~${NC}"
echo -e " ${NC} - $NC [${BRED}01$NC]${YELL} MENU SSH VIP  $NC   - [${BRED}16$NC]${YELL} REBOOT VPS              ${NC}$NC"
echo -e " ${NC} - $NC [${BRED}03$NC]${YELL} MENU VLESS    $NC   - [${BRED}17$NC]${YELL} RESTART VPS             ${NC}$NC"   
echo -e " ${NC} - $NC [${BRED}04$NC]${YELL} MENU TROJAN   $NC   - [${BRED}18$NC]${YELL} SET DOMAIN              ${NC}$NC" 
echo -e " ${NC} - $NC [${BRED}05$NC]${YELL} MENU SHADOW   $NC   - [${BRED}19$NC]${YELL} CERT SSL                ${NC}$NC"
echo -e " ${NC} - $NC [${BRED}06$NC]${YELL} MENU TRIAL    $NC   - [${BRED}20$NC]${YELL} INSTALL UDP             ${NC}$NC"
echo -e " ${NC} - $NC [${BRED}07$NC]${YELL} CEK RAM/CPU   $NC   - [${BRED}21$NC]${YELL} CLEAR CACHE             ${NC}$NC"
echo -e " ${NC} - $NC [${BRED}08$NC]${YELL} DELL ALL EXP  $NC   - [${BRED}22$NC]${YELL} CEK BANDWITH            ${NC}$NC"
echo -e " ${NC} - $NC [${BRED}09$NC]${YELL} AUTO REBOOT   $NC   - [${BRED}23$NC]${YELL} UP SCRIPT               ${NC}$NC"
echo -e " ${NC} - $NC [${BRED}10$NC]${YELL} MENU PORT     $NC   - [${BRED}24$NC]${YELL} MENU BOT VIP            ${NC}$NC" 
echo -e " ${NC} - $NC [${BRED}11$NC]${YELL} SPEEDTEST     $NC   - [${BRED}25$NC]${YELL} CHANGE BANNER SSH       ${NC}$NC"
echo -e " ${NC} - $NC [${BRED}12$NC]${YELL} RUNNING CEK   $NC   - [${BRED}26$NC]${YELL} LOG CREATE USER ACCOUNT ${NC}$NC"
